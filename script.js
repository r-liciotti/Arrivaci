...
function createObbiettivo() {
    ...
    while (true) {
        ...
        ((divY + 60) < navPosition.top || (divY + 60) > navPosition.bottom))) {
            ...
            // console.log("counterPosition.left: " + counterPosition.left);
            // console.log("counterPosition.right: " + counterPosition.right);
            // console.log("counterPosition.top: " + counterPosition.top);
            // console.log("counterPosition.bottom: " + counterPosition.bottom);
    
            // console.log("divX < counterPosition.left: " + (divX + 60 < counterPosition.left));
            // console.log("divX > counterPosition.right: " + (divX + 60 > counterPosition.right));
            // console.log("divY < counterPosition.top: " + (divY + 60 < counterPosition.top));
            // console.log("divY > counterPosition.bottom: " + (divY + 60 > counterPosition.bottom));
            // console.log("---");
            // console.log("divX < navPosition.left: " + (divX + 60 < navPosition.left));
            // console.log("divX > navPosition.right: " + (divX + 60 > navPosition.right));
            // console.log("divY < navPosition.top: " + (divY + 60 < navPosition.top));
            // console.log("divY > navPosition.bottom: " + (divY + 60 > navPosition.bottom));
